(function(angular) {
  ...
  mod.provider('formControlService', function() {
    ...
    self.defaults = {
      ...
      templates: {
        formCheckbox: {
          template:           'ngFormLib/controls/formCheckbox/template/FormCheckboxTemplate.html'
        },
        formDate: {
        ...
        formSelect: {
          template:           'ngFormLib/controls/formSelect/template/FormSelectTemplate.html'
        },
        requiredMarker: {
          template:           'ngFormLib/controls/requiredMarker/template/RequiredMarkerTemplate.html'
        }
      }
    };
