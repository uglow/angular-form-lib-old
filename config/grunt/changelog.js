/**
 * This is a fork of grunt-conventional-changelog.
 *
 * This fork adds the ability to set the from-tag when producing commit messages.
 * It solves the problem where more build tags exist than project-version tags,
 * and by-default the from-tag that the task uses is the previous tag (whatever it is)
 */
